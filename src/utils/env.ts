...
export const CONSTANTS = {
  ...
  LOG_LEVEL_ADMIN_TOKEN: env.LOG_LEVEL_ADMIN_TOKEN || '',
  ...
  NINE_TO_FIVE_MEETING_LINK: env.NINE_TO_FIVE_MEETING_LINK || '',
  YOUTUBE_PLAYLIST_URL: env.YOUTUBE_PLAYLIST_URL || 'https://www.googleapis.com/youtube/v3/playlistItems',
  YOUTUBE_PLAYLIST_API_KEY: env.YOUTUBE_PLAYLIST_API_KEY || 'playlistAPIKey',
  YOUTUBE_PLAYLIST_ID: env.YOUTUBE_PLAYLIST_ID || 'playlistID',
  YOUTUBE_PLAYLIST_MAX_RESULT: env.YOUTUBE_PLAYLIST_MAX_RESULT || 40,
  YOUTUBE_PLAYLIST_NAMES: env.YOUTUBE_PLAYLIST_NAMES || 'PM_TALK_LIST,COURSE_PREVIEW,KARMAYOGI_TALKS',
  YOUTUBE_VIDEOS: env.YOUTUBE_VIDEOS || 'https://www.googleapis.com/youtube/v3/videos',
  PM_TALK_LIST: env.PM_TALK_LIST || 'pmTalksList',
  COURSE_PREVIEW: env.COURSE_PREVIEW || 'coursePreview',
  KARMAYOGI_TALKS: env.KARMAYOGI_TALKS || 'karmayogiTalks',
